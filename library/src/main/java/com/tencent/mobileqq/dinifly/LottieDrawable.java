...
public class LottieDrawable extends Drawable implements Drawable.Callback {
   ...
   * member compositionLayer getter.
   */
  @Nullable public CompositionLayer getCompositionLayer() {
    return compositionLayer;
  }
   ...
   * quality loss.
   */
  @SuppressWarnings("WeakerAccess") public void setScale(float scaleX, float scaleY) {
    this.scaleX = scaleX;
    this.scaleY = scaleY;
    updateBounds();
  }
  ...
  private void updateBounds() {
    ...
    setBounds(0, 0, (int) (composition.getBounds().width() * scaleX),
        (int) (composition.getBounds().height() * scaleY));
  }
  ...
  @SuppressWarnings("WeakerAccess") public void endAnimation() {
    playAnimationWhenCompositionAdded = false;
    reverseAnimationWhenCompositionAdded = false;
    animator.end();
  }
  ...
  @SuppressWarnings("WeakerAccess") public void removeAnimatorListener(Animator.AnimatorListener listener) {
    ...
    @SuppressWarnings("WeakerAccess") public void removeAllAnimatorListener() {
        animator.removeAllListeners();
    }

  @Override public int getIntrinsicWidth() {
    return composition == null ? -1 : (int) (composition.getBounds().width() * scaleX);
  }

  @Override public int getIntrinsicHeight() {
    return composition == null ? -1 : (int) (composition.getBounds().height() * scaleY);
  }
